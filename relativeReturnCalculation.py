    ...
    for x in range(0,len(stocks)-1):   # -1 means to remove market index returns (not to repeat again)
        ...
        with open('relative returns data/'+stocks["Company Name"][x]+".csv", 'a') as file:
            ...
            for y in range (0,nOfIterations-10):
                ...
                # assign the class label of different return thresholds 0.3%, 0.5%, ............, 10%
                if (max(relativeReturns[15:25]) > 0.30000):
                    labelP3=1
                
                else:
                    labelP3=0
                
                if (max(relativeReturns[15:25]) > 0.50000):
                    labelP5=1
                
                else:
                    labelP5=0
                
                if (max(relativeReturns[15:25]) > 1.00000):
                    label1=1
                
                else:
                    label1=0
                
                if (max(relativeReturns[15:25]) > 1.50000):
                    labelOneP5=1
                
                else:
                    labelOneP5=0
                
                if (max(relativeReturns[15:25]) > 1.80000):
                    labelOneP8=1
                
                else:
                    labelOneP8=0
                
                if (max(relativeReturns[15:25]) > 2.00000):
                    label2=1
                
                else:
                    label2=0
                
                if (max(relativeReturns[15:25]) > 2.20000):
                    labelTwoP2=1
                
                else:
                    labelTwoP2=0
                
                if (max(relativeReturns[15:25]) > 2.50000):
                    labelTwoP5=1
                
                else:
                    labelTwoP5=0
                
                if (max(relativeReturns[15:25]) > 2.80000):
                    labelTwoP8=1
                
                else:
                    labelTwoP8=0
                
                if (max(relativeReturns[15:25]) > 3.00000):
                    label3=1
                
                else:
                    label3=0
                
                if (max(relativeReturns[15:25]) > 3.50000):
                    labelThreeP5=1
                
                else:
                    labelThreeP5=0
                
                if (max(relativeReturns[15:25]) > 4.00000):
                    label4=1
                
                else:
                    label4=0
                
                if (max(relativeReturns[15:25]) > 4.50000):
                    labelFourP5=1
                
                else:
                    labelFourP5=0
                
                if (max(relativeReturns[15:25]) > 5.00000):
                    label5=1
                
                else:
                    label5=0
                
                if (max(relativeReturns[15:25]) > 5.50000):
                    labelFiveP5=1
                
                else:
                    labelFiveP5=0
                
                if (max(relativeReturns[15:25]) > 6.00000):
                    label6=1
                
                else:
                    label6=0
                
                if (max(relativeReturns[15:25]) > 6.50000):
                    labelSixP5=1
                
                else:
                    labelSixP5=0
                
                if (max(relativeReturns[15:25]) > 7.00000):
                    label7=1
                
                else:
                    label7=0
                
                if (max(relativeReturns[15:25]) > 7.50000):
                    labelSevenP5=1
                
                else:
                    labelSevenP5=0
                
                if (max(relativeReturns[15:25]) > 8.00000):
                    label8=1
                
                else:
                    label8=0
                
                if (max(relativeReturns[15:25]) > 8.50000):
                    labelEightP5=1
                
                else:
                    labelEightP5=0
                
                if (max(relativeReturns[15:25]) > 9.00000):
                    label9=1
                
                else:
                    label9=0
                
                if (max(relativeReturns[15:25]) > 9.50000):
                    labelNineP5=1
                
                else:
                    labelNineP5=0
                
                if (max(relativeReturns[15:25]) > 10.00000):
                    label10=1
